...
import com.shagaba.kickstarter.common.domain.message.Message;
import com.shagaba.kickstarter.common.domain.message.MessageType;
import com.shagaba.kickstarter.common.domain.message.SimpleMessage;
...
public class LoginAuthenticationFailureHandler extends SimpleUrlAuthenticationFailureHandler {
	...
	public void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response, AuthenticationException exception)
		...
		// Message message = new SimpleMessage(MessageType.ERROR,
