...
import com.shagaba.kickstarter.rest.controller.profile.PersonalInformationController;
...
public class PersonalInformationControllerImpl implements PersonalInformationController {
    ...
    public PersonalInformation create(@Valid @RequestBody PersonalInformation personalInformation) {
        com.shagaba.kickstarter.core.domain.profile.PersonalInformation corePersonalInformation = mappingService.map(personalInformation, com.shagaba.kickstarter.core.domain.profile.PersonalInformation.class);
    ...
    public List<PersonalInformation> getAllPersonalInformations() {
        List<com.shagaba.kickstarter.core.domain.profile.PersonalInformation> corePersonalInformations = personalInformationService.getAllPersonalInformations();
    ...
    public PersonalInformation getPersonalInformationById(@PathVariable("id") String accountId) throws Exception {
        com.shagaba.kickstarter.core.domain.profile.PersonalInformation corePersonalInformation = personalInformationService.getPersonalInformationByAccountId(accountId);
        return mappingService.map(corePersonalInformation, PersonalInformation.class);
    }

    @RequestMapping(method = RequestMethod.PUT)
    public PersonalInformation update(@Valid @RequestBody PersonalInformation personalInformation) throws Exception {
        com.shagaba.kickstarter.core.domain.profile.PersonalInformation corePersonalInformation = personalInformationService.getPersonalInformationByAccountId(personalInformation.getAccountId());
