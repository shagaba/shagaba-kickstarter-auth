...
public class Address {
	...
	public String toString() {
		return String
				.format("Address {name=%s, firstName=%s, lastName=%s, companyName=%s, addressLine1=%s, addressLine2=%s, addressLine3=%s, street=%s, streetNumber=%s, city=%s, state=%s, county=%s, country=%s, postalCode=%s, zip=%s, phonePrimary=%s, phoneSecondary=%s, phoneFax=%s, longitude=%s, latitude=%s}",
						name, firstName, lastName, companyName, addressLine1, addressLine2, addressLine3, street, streetNumber, city,
						state, county, country, postalCode, zip, phonePrimary, phoneSecondary, phoneFax, longitude, latitude);
	}
