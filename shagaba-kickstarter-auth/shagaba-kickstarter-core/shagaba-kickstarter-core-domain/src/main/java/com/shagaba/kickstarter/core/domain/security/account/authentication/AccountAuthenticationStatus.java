...
import com.shagaba.kickstarter.core.common.audit.AuditingDomain;
import com.shagaba.kickstarter.core.common.domain.AccountIdentifiable;

@Document
public class AccountAuthenticationStatus extends AuditingDomain implements AccountIdentifiable<String> {
	...
	public String toString() {
		return String
				.format("AccountAuthenticationStatus {accountId=%s, isRegistered=%s, isEmailVerified=%s, accountToken=%s, logingAuthTraking=%s, tokenAuthTraking=%s, lockoutExperation=%s, lockoutType=%s, passwordStatus=%s}",
						accountId, isRegistered, isEmailVerified, accountToken, logingAuthTraking, tokenAuthTraking, lockoutExperation,
						lockoutType, passwordStatus);
	}
