package com.shagaba.kickstarter.auth.core.security.authentication.provider;
...
public class AccountPasswordAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        UserAccountDetails userAccountDetails = (UserAccountDetails) accountDetailsManager.loadUserByUsername(username);
