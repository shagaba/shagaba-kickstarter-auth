...
import com.shagaba.kickstarter.auth.core.domain.security.account.authentication.AuthenticationAttempt;
import com.shagaba.kickstarter.auth.core.domain.security.account.authentication.AuthenticationAttemptStatus;
import com.shagaba.kickstarter.auth.core.domain.security.account.authentication.AuthenticationTraking;
import com.shagaba.kickstarter.auth.core.domain.security.account.authentication.LockoutType;
...
public class AccountAuthenticationStatusManager {
    ...
    public AccountAuthenticationStatus updateTokenAuthenticationSuccess(UserAccountDetails userAccountDetails, WebAuthenticationDetails webAuthenticationDetails) {
        ...
        AccountToken accountToken = accountTokenAuthenticationManager.generateToken(userAccountDetails);
        AuthenticationTraking tokenAuthTraking = addAuthenticationAttempt(accountAuthenticationStatus.getTokenAuthTraking(), new AuthenticationAttempt(webAuthenticationDetails.getRemoteAddress(), accountToken.getTimestamp(), AuthenticationAttemptStatus.SUCCESSFUL));
